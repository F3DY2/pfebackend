...
namespace pfebackend.Migrations
{
    ...
    [Migration("20250517133255_change_model_prediction_variables")]
    partial class change_model_prediction_variables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("pfebackend.Models.User", b =>
                {
                    ...
                    b.Property<int?>("TotalNumberOfBedrooms")
                        .HasColumnType("int");

                    b.Property<int?>("TotalNumberOfCars")
                        .HasColumnType("int");
